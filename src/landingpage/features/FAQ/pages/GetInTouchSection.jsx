    ...
    <section className="relative px-5 py-20 sm:px-10 lg:px-20">
      <div className="text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <NavLink to="/apply" className="bg-transparent border font-semibold font-heading rounded-xl border-brand-placeholder text-brand-title px-10 py-3 transition hover:bg-brand-offwhite">
            Start Application
          </NavLink>
        </div>
      </div>
