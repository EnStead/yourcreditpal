  ...
  'do-not-sell': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['Certain state privacy laws may provide users with rights related to:'],
        bullets: [
        ...
        paragraphsAfter: ['Rights may vary depending on state regulations and eligibility requirements.'],
      },
      {
        ...
        subBullets: ['lender matching', 'fraud prevention', 'communication delivery', 'platform optimization'],
        paragraphsAfter: ['Additional information is available in our Privacy Policy.'],
      },
      {
      ...
      },
      {
        ...
        paragraphsAfter: ['Incomplete or unverifiable requests may not be processed.'],
      },
      {
      ...
      },
      {
        ...
        bullets: ['clicking unsubscribe links', 'replying STOP to SMS messages', 'contacting support directly'],
        paragraphsAfter: ['Operational communications related to applications or lender activity may still be required.'],
      },
      {
      ...
      },
      {
        ...
        linkText: 'support@yourcreditpal.com',
        linkHref: 'mailto:support@yourcreditpal.com',
      },
    ],
  ...
  'marketing-partners': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['Users may manage or limit promotional communications by:'],
        bullets: ['clicking unsubscribe links', 'replying STOP to SMS messages', 'contacting support directly'],
        paragraphsAfter: ['Some operational or transactional communications may still be required for application processing.'],
      },
      {
  ...
  'electronic-consent': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['To access and retain electronic communications, users should have:'],
        bullets: ['internet access', 'a supported web browser', 'a valid email address', 'access to a device capable of viewing PDFs or electronic documents'],
        paragraphsAfter: ['Users are responsible for maintaining updated contact information and system compatibility.'],
      },
      {
      ...
      },
      {
        ...
        paragraphsAfter: ['Failure to maintain updated contact information may affect communication delivery.'],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphsAfter: ['Applicants should carefully review all lender-provided disclosures before accepting any loan offer.'],
      },
      {
        ...
        bullets: ['repayment schedule', 'interest rates', 'APR', 'loan duration', 'applicable fees', 'payment obligations'],
        paragraphsAfter: ['Users are encouraged to review all terms carefully before electronically signing any agreement.'],
      },
      {
        title: '3. Repayment Responsibility',
        paragraphs: ['Borrowers are responsible for repaying loans according to the terms established by the lender.'],
        paragraphsAfter: ['Failure to meet repayment obligations may result in:'],
        bullets: ['additional fees', 'collection activity', 'negative credit reporting', 'legal action depending on lender policies and applicable laws'],
      },
      {
        ...
        bullets: ['payment due dates', 'grace periods', 'late fees', 'collection procedures'],
      },
      {
        ...
        cards: [
          ...
          { title: 'Late Payments', body: 'Missing payments may negatively affect your credit profile.' },
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ['Loans should be used responsibly and only for legitimate financial needs.', 'Applicants are encouraged to:'],
        bullets: [
    ...
    sections: [
      {
        ...
        paragraphsAfter: ['Information may be collected directly from users or automatically through website technologies.'],
      },
      {
      ...
      },
      {
        ...
        paragraphsAfter: ['Information is shared only as necessary to support platform operations and loan matching services.'],
      },
      {
        title: '4. Communications & Marketing Preferences',
        paragraphs: ['Users may receive communications related to:'],
        bullets: ['loan applications', 'lender matching', 'platform updates', 'marketing offers'],
        paragraphsAfter: ['Users may opt out of promotional communications by:'],
        subBullets: ['clicking unsubscribe links', 'replying STOP to SMS messages', 'contacting support directly'],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ['Depending on applicable laws and state regulations, users may have rights related to:'],
        bullets: ['accessing personal information', 'requesting corrections', 'requesting deletion', 'limiting data sharing', 'opting out of marketing communications'],
        paragraphsAfter: ['Requests may be submitted through our support channels.'],
      },
      {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphsAfter: ['Users should carefully review all lender-provided terms before accepting any offer.'],
      },
      {
      ...
      },
      {
        title: '12. Contact Us',
        anchor: 'contact-information',
        paragraphs: ['If you have questions regarding these Terms & Conditions, please contact:'],
        linkText: 'support@yourcreditpal.com',
        linkHref: 'mailto:support@yourcreditpal.com',
      },
    ],
