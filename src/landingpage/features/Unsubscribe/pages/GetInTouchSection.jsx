...
const GetInTouchSection = () => {
  return (
    <section className="relative bg-brand-lightblue px-5 py-20 sm:px-8 lg:px-20">
      <div className="text-center">
        ...
        <h2 className="mx-auto my-8 max-w-xl text-4xl font-bold text-brand-title md:text-5xl">
